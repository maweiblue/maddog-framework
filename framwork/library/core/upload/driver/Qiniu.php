...
use core\upload\driver\Qiniu\QiniuStorage;
...
class Qiniu{
    ...
    private $config = array(
        'secrectKey'     => 'NPqk9aP8mHWqamFr7p4ifI-Cm_lJOxmjthTDfFcr', //七牛服务器
        'accessKey'      => 'XeWKVzh4LWqy1vRimeyJc_dqDAiOJ_OvwneVWK4G', //七牛用户
        'domain'         => 'p.jianduanseo.com', //七牛密码
        'bucket'         => 'images', //空间名称
        'timeout'        => 300, //超时时间
    );
